...
HD_PWD='C:/Users/themo/OneDrive/Desktop/REVO/V/Final/Simulation and Bench marking/USB_FIFO/USB_FIFO.runs/design_2_USB_FIFO_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_USB_FIFO_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_USB_FIFO_0_0.tcl
