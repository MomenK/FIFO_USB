...
# module references:
# Data_generator, MPairStorageController, USB_FIFO
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set AUX3 [ create_bd_port -dir O AUX3 ]
  set AUX4 [ create_bd_port -dir O AUX4 ]
  set D [ create_bd_port -dir IO -from 7 -to 0 D ]
  ...
  # Create instance: USB_FIFO_0, and set properties
  set block_name USB_FIFO
  set block_cell_name USB_FIFO_0
  if { [catch {set USB_FIFO_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $USB_FIFO_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net MPairStorageControll_0_DatOut [get_bd_pins MPairStorageControll_0/DatOut] [get_bd_pins USB_FIFO_0/data_in]
  connect_bd_net -net MPairStorageControll_0_Done [get_bd_ports AUX4] [get_bd_pins MPairStorageControll_0/Done] [get_bd_pins USB_FIFO_0/enable_n]
  connect_bd_net -net MPairStorageControll_0_Full [get_bd_ports AUX3] [get_bd_pins MPairStorageControll_0/Full] [get_bd_pins USB_FIFO_0/enable_p]
  connect_bd_net -net Net [get_bd_ports D] [get_bd_pins USB_FIFO_0/data]
  connect_bd_net -net RXF_n_1 [get_bd_ports RXF_n] [get_bd_pins USB_FIFO_0/rxf_n]
  connect_bd_net -net TXE_n_1 [get_bd_ports TXE_n] [get_bd_pins USB_FIFO_0/txe_n]
  connect_bd_net -net USB_FIFO_0_new_input_Clk [get_bd_pins MPairStorageControll_0/ClkOut] [get_bd_pins USB_FIFO_0/new_input_Clk]
  connect_bd_net -net USB_FIFO_0_output_led [get_bd_pins Data_generator_0/rst] [get_bd_pins MPairStorageControll_0/P_Rst] [get_bd_pins USB_FIFO_0/output_led]
  connect_bd_net -net USB_FIFO_0_rd_n [get_bd_ports RD_n] [get_bd_pins USB_FIFO_0/rd_n]
  connect_bd_net -net USB_FIFO_0_wr_n [get_bd_ports WR_n] [get_bd_pins USB_FIFO_0/wr_n]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins USB_FIFO_0/clk] [get_bd_pins clk_wiz_1/clk_out1]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins USB_FIFO_0/rst] [get_bd_pins clk_wiz_1/reset] [get_bd_pins util_vector_logic_0/Res]
