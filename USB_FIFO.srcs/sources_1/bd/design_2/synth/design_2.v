...
module design_2
   (AUX4,
    ...
    sys_clock);
  output AUX4;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.D DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.D, LAYERED_METADATA undef" *) inout [7:0]D;
  output RD_n;
  input RXF_n;
  input TXE_n;
  output WR_n;
